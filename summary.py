...
DAY = len(sys.argv) == 1 or sys.argv[1].lower() == 'day'
WEEK = len(sys.argv) == 1 or sys.argv[1].lower() == 'week'
MONTH = len(sys.argv) == 1 or sys.argv[1].lower() == 'month'
YEAR = len(sys.argv) == 1 or sys.argv[1].lower() == 'year'
